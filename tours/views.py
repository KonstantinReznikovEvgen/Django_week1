...
def main_view(request):
    numbers = range(1, 16)
    random_tours = [tours[key] for key in random.sample(numbers, 6)]
    context = {'description': """Лучшие направления, где никто
     не будет вам мешать сидеть на берегу и изучать программирование, 
дизайн, разработку игр и управление продуктами """, 'title': "Stepik Travel", 'subtitle': "Для тех, кого отвлекают дома"
               , 'tours': random_tours}
